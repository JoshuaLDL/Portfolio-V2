    ...
    return(
        <div>
            ...
            <TextBox 
                ...
                text="The conception of gossip emerged in a historical context as a term of endearment. Used originally to indicate a close friend among females, it has since been used to ‘[signify] idle, backbiting talk, that is, talk potentially sowing discord’ the polar opposite of the intended meaning. (Federici, S 2018) This shift in meaning, for the once endearing term, served to destroy the female sociality that had arisen in the middle ages, a time when most activities carried out by women were done as a collective within a tight-knit community. 
            ...
            <TextBox 
                title="Websites" 
                text="Brown, O. (2020) ‘Why Are Women Still Behind in the Design World?’ [online] Available at: https://modus.medium.com/why-are-women-still-behind-in-the-design-world-5eb3b56c43f5 [Accessed: 27 October 2020]
                ...
                3percentmovement (2014) ’Female CDS on the Rise’ [Online] Available at: https://www.3percentmovement.com/sites/default/files/resources/3percent-ResearchResults_FINAL.pdf [Accessed: 4 November 2020]
" 
            />

            <TextBox 
                title="E-Journals" 
                text="Andrew, E. (1975) ‘Marx's Theory of Classes: Science and Ideology’ [online] Available at:
                ...
                Power, K. (2020) ‘The COVID-19 pandemic has increased the care burden of women and families’ [online] Available at: https://www.tandfonline.com/doi/full/10.1080/15487733.2020.1776561?scroll=top&needAccess=true [Accessed: 9 November 2020]
" 
            />

            <TextBox 
                title="Books and Papers" 
                text="Davis, A. (1981) ‘Women, Class and Race’ [Online] Available at: https://legalform.files.wordpress.com/2017/08/davis-women-race-class.pdf [Accessed: 10 November 2020]
