    ...
    return (
        <div>
            ...
            <div className="aboutSectionTwo">
                ...
                <TimelineCubes experience="JUNIOR SOFTWARE DEVELOPER" time="HTMLEPHANTS 2025" text="Working as part of a software team, I was a part of building a web app allowing allowing users to view available books, search for books by name, filter books by genre, view claimed books, claim a book themselves, review books and even add new books to the system. This was invaluable for teaching me how to effectively drive and navigate in pair-programming and work as a wider dev team using agile methodology and Git." />
