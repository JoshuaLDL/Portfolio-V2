    ...
    return (
        <div>
            ...
            <div className="aboutSectionTwo">
                ...
                <TimelineCubes experience="DIGITAL MARKETING ASSISTANT" time="ARV SOLUTIONS 2020-2022" text="Here I learned how to single-handedly manage a workload while collaborating with different departments to deliver projects and meet deadlines for the needs of the business. 
                This role taught me the value of applying my skills as a designer solve problems with a unique perspective." />
